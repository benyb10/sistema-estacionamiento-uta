...
SECRET_KEY = 'django-insecure-c9ne_sgw9&@1^*@qxvexh4poond3%j*4xv-*40)ne0t+don&k5'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#ALLOWED_HOSTS = ['192.168.0.110', 'localhost', '127.0.0.1', '192.168.56.1']
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '[::1]''192.168.1.18', '0.0.0.0', '*' ]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'bnnachito@gmail.com'
EMAIL_HOST_PASSWORD = 'yhfo ywlz phyp qpbi'

ASGI_APPLICATION = 'ProyectoIS.asgi.application'

CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'channels.layers.InMemoryChannelLayer',  # o channels_redis si usas Redis
    }
}
...
SIMPLE_JWT = {
    ...
    'USER_ID_FIELD': 'cedula',  # ✅ IMPORTANTE: Usar cédula como ID de usuario
